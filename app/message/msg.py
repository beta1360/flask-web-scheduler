...
FAIL_ADD_GROUP = "그룹 생성에 실패하였습니다."
FAIL_ENTER_GROUP = "그룹 가입에 실패하였습니다."

DUPLICATE_USER_CODE = "이미 등록된 유저입니다. ID를 확인해주세요."
DUPLICATE_GROUP_CODE = "이미 등록된 그룹입니다."
